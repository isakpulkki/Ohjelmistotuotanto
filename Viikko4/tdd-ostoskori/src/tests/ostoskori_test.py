...
class TestOstoskori(unittest.TestCase):
    ...
    def test_jos_korissa_on_kaksi_samaa_tuotetta_ja_toinen_niista_poistetaan_koriin_jaa_ostos_jossa_on_yksi_tuote(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_jos_koriin_lisatty_tuote_ja_se_poistetaan_niin_kori_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostos = self.kori.ostoslista()[0]
    ...
    def test_tyhjentaminen_tyhjentaa_listan(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.tyhjenna()
        self.assertEqual(len(self.kori.ostoslista()), 0)
